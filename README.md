...
当前入口：[Revision 4 交接与验证边界](nba2k-arena/docs/REVISION4_ZH.md)。

- [下载 Revision 4 完整压缩包](nba2k-arena/output/revision4/venice_court_revision4.zip)：包含同编号的两份 IFF 及校验信息。
- [产物校验](nba2k-arena/output/revision4/validation.json)
...
Revision 4 补充双弯臂路灯、桶组细节、看台支撑与草台回转，并修复草台外的缺地。静态资源检查和导出几何预览不等于 NBA 2K 游戏画面验收；天空、树木着色、日影及完整室外篮架仍待实际验证或补齐资源。原 donor、历史输出、原场地与篮筐变换、碰撞和玩法锚点均保留。开发过程不会安装建模软件或写入游戏目录。
...
python3 nba2k-arena/scripts/revision4_preview.py --three-dir /path/to/three
```
